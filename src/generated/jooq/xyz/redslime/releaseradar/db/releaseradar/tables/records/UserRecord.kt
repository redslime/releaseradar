...
open class UserRecord() : UpdatableRecordImpl<UserRecord>(User.USER), Record7<Long?, String?, String?, String?, String?, Boolean?, Boolean?> {
    ...
    public override fun valuesRow(): Row7<Long?, String?, String?, String?, String?, Boolean?, Boolean?> = super.valuesRow() as Row7<Long?, String?, String?, String?, String?, Boolean?, Boolean?>
    ...
    public override fun field7(): Field<Boolean?> = User.USER.SKIP_EXTENDED
    ...
    public override fun component7(): Boolean? = skipExtended
    ...
    public override fun value7(): Boolean? = skipExtended
    ...
    public override fun value7(value: Boolean?): UserRecord {
        set(6, value)
        return this
    }

    public override fun values(value1: Long?, value2: String?, value3: String?, value4: String?, value5: String?, value6: Boolean?, value7: Boolean?): UserRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
